...
export const human = (color, classes) => (
  <svg className={classes} width={'100%'} height={'100%'} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
       x="0px" y="0px"
       viewBox="0 0 297 297" xmlSpace="preserve">
    <g>
      <ellipse fill={color} cx="148.5" cy="34.611" rx="34.458" ry="34.611"/>
      <path fill={color} d="M222.403,176.902l-8.645-60.51C210.586,95.554,192.096,78.6,172.541,78.6h-3.001c-6.37,3.078-13.508,4.806-21.04,4.806
